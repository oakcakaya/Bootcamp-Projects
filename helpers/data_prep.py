...
def outlier_thresholds(dataframe, col_name, lowertreshold=0.05, uppertreshold=0.95):
    quartile1 = dataframe[col_name].quantile(lowertreshold)
    quartile3 = dataframe[col_name].quantile(uppertreshold)
