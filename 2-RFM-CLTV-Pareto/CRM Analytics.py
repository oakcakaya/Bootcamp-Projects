...
def create_rfm(dataframe):
    ...
    # Monetary segment excluded since it has not been used.
...
def create_cltv_p(dataframe):
    ...
    # Calculation of  WEEKLY RECENCY & WEEKLY T for IBGNBD için
    ...
    ## recency filter (for better cltv_p calculation)
...
##########################################
crm_final.head()
# To prevent mismatching reshape Customer ID as "CustomerID".
